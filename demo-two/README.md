...
**Demo Two** a sub mudule of Muscle and Fitness Server (M&F).

[Official Docker Image](https://hub.docker.com/r/ijohnnymiller/demo-two-prod)

## Features

Here is the highlights of **Demo Two**:
...
2. Interact with Demo One with Spring Cloud OpenFeign.
